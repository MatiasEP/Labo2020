...
<body>
    <div class="container">
        ...
        <div class="subcontener">
            ...
            <button id="favorito" class="agregar btn btn-primary">Agregar a favoritos</button>
            ...
            <div class="" id="nuevoComentario">
                ...
                <textarea name="inputComentario" class="form-control" id="inputComentario" cols="40" rows="8" placeholder="Ingrese su comentario..." minlength="2" maxlength="250"></textarea> <br><br>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formReporte" action="">
                            ...
                            <div class="form-group" id="mod_report">
                                <label for="reporte" class="subtitle_report">Reporte</label>
                                <textarea class="box_report form-control" name="reporte" id="reporte" cols="40" rows="8" placeholder="Ingrese la razon del reporte..." minlength="2" maxlength="100"></textarea><br>
                            </div>
